    ...
    <div class="popup_wrap" style="display: block;">
        <div class="popup" id="department_add">
            ...
            <div class="content_area">
                ...
                <input type="text" id="teacher_birth" placeholder="생년월일(8자리)">
                <input type="text" id="teacher_phone" placeholder="전화번호">
                <input type="text" id="teacher_email" placeholder="이메일">
            ...
            <div class="btn_area">
                <button id="add_teacher">등록하기</button>
                <button id="modify_teacher">수정하기</button>
                <button id="cancel_teacher">취소하기</button>
            </div>
        </div>
    </div>
</body>
